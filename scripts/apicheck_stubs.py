...
add('net.minecraft.block.Blocks', [], [
    ...
    'public static final net.minecraft.block.Block STONE_BRICKS;', 'public static final net.minecraft.block.Block BRICKS;', 'public static final net.minecraft.block.Block BELL;', 'public static final net.minecraft.block.Block OAK_LEAVES;', 'public static final net.minecraft.block.Block DARK_OAK_SLAB;', 'public static final net.minecraft.block.Block GLOWSTONE;', 'public static final net.minecraft.block.Block COAL_BLOCK;', 'public static final net.minecraft.block.Block IRON_BARS;', 'public static final net.minecraft.block.Block STONE_BRICK_STAIRS;',

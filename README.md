...
Right-click an unclaimed survivor with a **Recruitment Contract**. Right-click a recruited companion with an empty hand to switch between follow and guard. Feed them cooked beef or a golden carrot to build trust.

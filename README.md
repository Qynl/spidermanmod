...
- **A performed voice catalog (69 lines and growing)** for almost every moment: sieges, the town crier announcing big news aloud to every player, warm and folksy hellos ("Well hello there, Mister!"), **per-culture greetings** (knights, pirates, outlaws, sky captains, hearthfolk — each says hello its own way), **and the hello changes with your reputation** — the hated are told to state their business and move along, true friends of the town get a hero's welcome; voiced idle musings by the fire, feeding praise, the recruitment handshake, bitter betrayals, the THIEF! shout over stolen crops, "lower that crossbow" warnings, **trader patter and haggling**, **the harvest market herald**, farewells, celebration, the lost child's plea, **battle barks over the din and raider threats at travelers**, **hired swords checking in with their captain**, **tense standoffs when rival banners share a street**, **children who demand their favorite story again**, the **wedding officiant's blessing**, the **funeral eulogy** when a named settler falls, **the cry of an empty granary**, **cheers when a settlement grows**, **storm and earthquake cries**, **old-timers muttering** about buried treasure, **quarrels between rivals**, and **grief-struck or triumphant retellings** of a town's scars — the same story, told in the mood it left behind
...
- **Every structure rebuilt from reference builds**: Gorillo-style **watchtowers** now stand their own ground across the realm — stone drum, timber belfry under a dark pyramid, keeper's annex with a smoking chimney, and a warning lantern on a chain; **mine adits** bore into the hillsides by the sky ports (timber portal, torch-lit tunnel, coal in the walls); **lumber camps** stack bark logs by the sawhorse; a full **galleon** rides at anchor; market counters, bakery ovens, barbicans, grand cranes and hangars, pub fronts, lighthouses, smithies and stilt huts

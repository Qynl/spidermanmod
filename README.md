...
- **Every structure rebuilt from reference builds**: striped **lighthouses** rise on harbor headlands; the **smithy** works under a smoking stone chimney with an anvil-and-coal yard; **stilt fishing huts** stand on rugged legs in the tide; raider camps keep a **captured battering ram** on its chain-hung frame

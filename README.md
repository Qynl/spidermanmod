...
- **Every structure rebuilt from reference builds**: a full **galleon rides at anchor** in every harbor — striped hull, two masted yards under white canvas, bowsprit, stern castle and lantern-lit bulwarks; **market stalls** are solid counters with goods under thick striped canopies; the **bakery's brick dome oven** breathes smoke over the square; the citadel's approach runs under a **half-timbered barbican**; harbors raise the **grand timber crane**; airships sleep in **arched metal hangars**; taverns wear **hanging shield signs and striped awnings**

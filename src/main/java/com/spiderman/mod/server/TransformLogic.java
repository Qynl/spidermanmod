        ...
        while (powers.stage >= 0 && powers.stage < 4 && powers.stage < thresholds.length) {
            ...
            if (powers.mastery >= needed) {
                ...
                try {
                    ...
                    player.playSound(SoundUtil.unwrap(SoundEvents.UI_TOAST_CHALLENGE_COMPLETE), 0.8f, 1.3f);
                    player.playSound(SoundUtil.unwrap(SoundEvents.BLOCK_BEACON_ACTIVATE), 0.6f, 1.5f);
